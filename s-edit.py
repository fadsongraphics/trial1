...
def intent2action(intent):
  ...
  if intent == 'Utilities_Device_status':
    ...
    if quantity and currency:
      ...
      song = AudioSegment.from_wav("4.wav")
      play(song)
    ...
    song = AudioSegment.from_wav("5.wav")
    play(song)
    ...
    song = AudioSegment.from_wav("7.wav")
    play(song)

  elif intent == 'Love':
    song = AudioSegment.from_wav("8.wav")
    play(song)

  elif intent == 'Compliment':
    song = AudioSegment.from_wav("9.wav")
    play(song)
  
  elif intent == 'Hobby':
    song = AudioSegment.from_wav("10.wav")
    play(song)

  elif intent == 'get_personal':
    song = AudioSegment.from_wav("11.wav")
    play(song)

  elif intent == 'Pissed':
    song = AudioSegment.from_wav("12.wav")
    play(song)

  elif intent == 'Language':
    song = AudioSegment.from_wav("13.wav")
    play(song)

  elif intent == 'Boss':
    song = AudioSegment.from_wav("14.wav")
    play(song)

  elif intent == 'Retraining':
    song = AudioSegment.from_wav("15.wav")
    play(song)


  elif intent == 'Job':
    song = AudioSegment.from_wav("16.wav")
    play(song)
    ...
    song = AudioSegment.from_wav("17.wav")
    play(song)
    
  elif intent == 'Ask_question':

    song = AudioSegment.from_wav("18.wav")
    play(song) 
    
  elif intent == 'greeting':

    song = AudioSegment.from_wav("19.wav")
    play(song)
      
  elif intent == 'Utilities_Report_Outage':
    song = AudioSegment.from_wav("20.wav")
    play(song)
    ...
    play(song)
      ...
      song = AudioSegment.from_wav("Pipes.wav")
      play(song)
            ...
            while True:
                ...
                if rec.AcceptWaveform(data):
                    ...
                    if jres["text"]== str("hello james"):
                        ...
                        song = AudioSegment.from_wav("Beginning.wav")
                        play(song)
